...
const Create = ({teachers: {isSubmitted}, createTeacher, setAlert, history}) => {
    ...
    const submitForm = e => {
        ...
        if (validateForm(formData.errors)) {
            createTeacher(formData, history);
        } else {
            return;
        } 
    }
                                ...
                                <Col sm="12" md="4">
                                    <FormGroup>
                                        ...
                                        <Input 
                                            ...
                                            onChange={e => changeHandler(e)}
                                            invalid={formData.errors.staffNumber.length > 0}/>
                                        <FormFeedback>{formData.errors.staffNumber}</FormFeedback>  
                                    </FormGroup>
                                </Col>
                                <Col sm="12" md="4">
                                    <FormGroup>
...
export default connect(mapState, { createTeacher, setAlert })(withRouter(Create))
